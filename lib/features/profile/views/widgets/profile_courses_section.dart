    ...
    return BlocProvider(
      create: (context) =>
          ProfileCoursesCubit(profileCoursesRepo: getIt<ProfileCoursesRepo>())
            ..getMyCourses(),
      child: const _ProfileCoursesSectionBody(),
    );
  }
}

class _ProfileCoursesSectionBody extends StatefulWidget {
  const _ProfileCoursesSectionBody();

  @override
  State<_ProfileCoursesSectionBody> createState() =>
              ...
              builder: (context, state) {
                ...
                if (state is ProfileCoursesLoaded) {
                  return AnimatedBuilder(
                    ...
                    builder: (context, _) {
                      final courses = state.coursesForTab(_tabController.index);
...
class _ProfileCoursesList extends StatelessWidget {
  ...
  final List<StudentEnrollmentModel> courses;
      ...
      child: Center(
        child: Column(
          children: [
            ...
            TextButton(
              onPressed: () =>
                  context.read<ProfileCoursesCubit>().getMyCourses(),
